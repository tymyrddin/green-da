...
* with the [usual information gathering techniques](attack-trees:docs/reconnaissance/README) for example from work environments, such as personal information of/from colleagues, from dumpster diving, and from any public information, such as a voter list, petition sites, forum comments, or reviews in websites, to name but a few.
